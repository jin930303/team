...
function toggleStateOptions() {
    ...
    if (fileonoff === 'fileo') {
        ...
        document.querySelector('input[name="gimage"]').value = "fileno";
    }
}
...
<link href="./css/gongji/gongjiupdateview.css" rel="stylesheet"/>
<meta charset="UTF-8">
<title>
</title>
</head>
		...
		<form action="gongjiupdate" method="post" enctype="multipart/form-data">
			...
			<table>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" name="gtitle" value="${list.gtitle}" required="required">
