...
<caption><h2>공지사항</h2></caption>
	<tr>
		...
		<c:forEach items="${list}" var="list">
			<tr>
				<td>${list.gnum}</td><td style="text-align: left; border: 600px;"><a href="gongjidetail?gnum=${list.gnum}">${list.gtitle}</a></td><td>${list.nickname}</td><td>${list.gdate}</td><td>${list.gcnt}</td>
			</tr>
		</c:forEach>
