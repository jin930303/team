...
function toggleStateOptions() {
    ...
    if (fileonoff === 'fileo') {
        ...
        document.querySelector('input[name="simage"]').value = "fileno";
    }
}
...
<link href="./css/sosick/sosickupdateview.css" rel="stylesheet"/>
<meta charset="UTF-8">
<title>
</title>
</head>
		...
		<form action="sosickupdate" method="post" enctype="multipart/form-data">
			<table>
				...
				<tr>
					<th>제목</th>
					<td>
						<input type="text" name="stitle" value="${list.stitle}" required="required">
						<input type="hidden" name="snum" value="${list.snum}" readonly>
