...
<link href="./css/iljung/iljunginput.css" rel="stylesheet"/>
</head>
<body onload="toggleStateOptions(); toggleScoreFields();">
<div class="flex_container">
	<!-- 사이드 메뉴바 -->
	<div class="sidebar_container">
		<div class="sidebar_title"><h2>경기일정 WRITE</h2></div>
		<aside class="sidebar">
				<ul>
	...
	<main class="main-container">
			<form action="iljungsave" method="post">
				...
				<table>
					...
					<tr>
						<th>경기일자</th>
						<td><input type="date" name="gamedate" required></td>
					</tr>
					<tr>
						<th>홈팀</th>
						<td>
