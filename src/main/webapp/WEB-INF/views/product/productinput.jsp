...
<div class="container">
    <form action="productsave" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr><th>상품이름</th><td><input type="text" name="product" required></td></tr>
            
            <tr>
                <th>야구용품/구단별용품</th>
                <td>
                    <select name="cg_code" id="cg_code" onchange="updateScgCode()" required>
            ...
            <tr>
                <th>옵션선택</th>
                <td>
                    <select name="scg_code" id="scg_code" required>
                        <!-- 배트 옵션 -->
            ...
            <tr><th>상품가격</th><td><input type="number" name="price" required></td></tr>
            <tr>
                <th>할인율</th>
                <td>
                    <select name="sale">
            ...
            <tr><th>상품이미지</th><td><input type="file" name="image1" required></td></tr>
            <tr><th>상세내용이미지</th><td><input type="file" name="dimage" required></td></tr>
